...
local_repository(
    name = "lluvia",
    path = "/home/juan/workspace/git/lluvia",
)

# FIXME: load from lluvia a macro to declare all external dependencies
#        lluvia_rules_dependencies()
...
pip_import(
    name = "python_deps",
    requirements = "@lluvia//:requirements.txt",
)
